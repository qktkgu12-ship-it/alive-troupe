...
function HomeInner() {
  ...
  return (
    ...
    //
    // ⚠️ 카드 사이(20px)는 카드 **안쪽** 행 사이(16px)보다 늘 넓어야 한다.
    //    좁히거나 같아지면 카드 경계가 안 읽혀 화면이 한 줄짜리 긴 목록처럼 보인다.
    //    지금 비율 1.25 — 더 조이려면 카드 사이가 아니라 행 사이(MediaRow의 py-2)를
    //    같이 줄일 것. 24/16(1.50)에서 20/16(1.25)으로 내려온 상태다.
